...
const HRTask = () => {
  ...
  const handleTaskSubmit = (e) => {
    ...
    if (editingTask) {
      ...
      const taskToAdd = { id: `task_${Date.now()}`, title: newTask.title, description: newTask.description, assignedTo: newTask.assignedTo, dueDate: newTask.dueDate, priority: newTask.priority, assignedBy: user.employeeId, department: assignedUser.department, status: 'To Do', createdAt: new Date().toISOString(), fileName: newTask.file ? newTask.file.name : null, fileData: null };
  ...
  const getAssignableUsers = () => {
    return users.filter(u => u.department === user.department && u.employeeId !== user.employeeId);
  };
